                ...
                <Col className='col-12'>
                    ...
                    <Card.Body className="position-relative">
                        ...
                        <Col>
                            ...
                            <Flex>                    
                                <Button className="px-4 ms-3 fs-sm-0 fs--1" variant="falcon-primary" onClick={handleShow}>Invite User</Button>
                                </Flex>
                            </Col>
                            </Row>
                        </Col>
      ...
      >
        ...
        <Modal.Body>
          ...
          <Row className="mb-3 g-3">
            ...
            <Form.Select aria-label="Role" placeholder='Member' value={formData.role}
              name="role"
              onChange={handleChange}>
