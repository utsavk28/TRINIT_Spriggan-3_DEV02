...
const ProjectSelection = () => {
  ...
  return (
      ...
      <div className='container-fluid'>
        ...
        <Button className="btn btn-primary text-nowrap w-100" id="button-addon2" style={{height:"45px"}} onClick={handleShow}>
        <FontAwesomeIcon
                      icon="plus"
                      className="me-2 fs-1"
                      />
                 <span className='fs-1'> Click here to add project  </span>      
                  </Button>
        </Card.Body>
      </Card>
      <Modal
